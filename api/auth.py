...
class Auth:
    ...
    def get_refreshed_token(self, token: t.Token, force: bool = False) -> typing.Optional[t.Token]:
    ...
    def _get_token_from_shell(self, login: dict, forceRefresh: bool) -> typing.Optional[t.Token]:
