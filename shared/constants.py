...
class BuildMode:
    ...
    DEPLOY_TO_CLOUD = "deploy_to_cloud"  # From a local machine, send to AWS for Cloud run
    ALREADY_IN_CLOUD = "already_in_cloud"  # If it's already in AWS and now needs to be run
